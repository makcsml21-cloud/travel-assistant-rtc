...
def build_yandex_payload(req: TravelRequest) -> dict:
    base_prompt = (
        ...
        "или правилах — укажи, где пользователь может их найти. Всегда разделяй варианты на категории «средний бюджет» и «высокий бюджет». "
        "\n\n"
        ...
        "День 1\n- Достопримечательности (2–3 места): название, краткое описание, ориентировочное время на посещение (в минутах).\n- Проживание: 2 варианта (средний бюджет и высокий бюджет) с ориентировочным диапазоном цен за ночь в рублях.\n- Транспорт: как добраться до первой точки + варианты внутри города с примерной стоимостью.\n\nДень 2\n...\nДень 3\n...\n\nВ конце добавь блок «Где проверить актуальные данные» и перечисли 2–3 надёжных источника.\n\nНе задавай уточняющих вопросов, если город и бюджет уже указаны. Если каких-то данных не хватает — используй типичные рыночные диапазоны и обязательно пометь: «цены ориентировочные, актуальны на 2024 год»."
    )
